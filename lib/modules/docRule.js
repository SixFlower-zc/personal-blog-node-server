...
const { DocModule, ProjectModule, UserModule } = require('../../model')
...
const validateDocCreate = [
  ...
  body('title')
    ...
    .withMessage('文章标题长度必须在1-50个字符之间')
    .escape(),
  ...
  body('category')
    ...
    .withMessage('分类目录必须是有效的值：技术、随笔、生活、动漫、六花、其他'),
